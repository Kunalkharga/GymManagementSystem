...
<div class="lg:ml-64 min-h-screen pt-16 lg:pt-0 bg-gradient-to-br from-gray-900 via-gray-900 to-black">
    <div class="p-4 lg:p-8 max-w-7xl mx-auto">
        ...
        <?php if (isset($_GET['updated'])): ?>
            <div id="successToast"
                class="fixed top-6 right-6 bg-gradient-to-r from-green-600 to-green-700 text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-3 z-50 toast-slide">
                ...
                <div class="absolute bottom-0 left-0 h-1 bg-green-400 rounded-b-2xl progress-bar-animated" id="progressBar"
...
<?php endif; ?>
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8 fade-in-up">
            <div>
                <h1
                    class="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">
                    Member Profile
                </h1>
            </div>
        ...
        <!-- Main Profile Card -->
        <div class="bg-gray-900/50 backdrop-blur-sm rounded-3xl p-6 lg:p-8 border border-gray-800 fade-in-up"
            style="animation-delay: 0.1s;">

            <!-- Profile Header -->
            <div
                class="flex flex-col md:flex-row gap-8 items-center md:items-start mb-12 pb-8 border-b border-gray-800">
                <div class="relative flex-shrink-0 group">
                    ...
                    <?php else: ?>
                        <div
                            class="w-40 h-40 bg-gradient-to-br from-gray-700 to-gray-800 rounded-3xl flex items-center justify-center text-7xl border-4 border-orange-500">
                            <?= strtoupper(substr($member['full_name'], 0, 1)) ?>
                        </div>
                    <?php endif; ?>
                    <div class="absolute -bottom-2 -right-2 w-8 h-8 bg-green-500 rounded-full border-4 border-gray-900">
                    </div>
                </div>
                ...
                <div class="flex-1 text-center md:text-left">
                    ...
                    <div class="mt-6 flex flex-wrap justify-center md:justify-start gap-3">
                        ...
                        <div
                            class="px-5 py-2.5 rounded-xl text-sm flex items-center gap-2 <?= $isExpired ? 'bg-red-500/20 text-red-400' : 'bg-green-500/20 text-green-400' ?>">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <div
                    class="stat-card bg-gradient-to-br from-gray-800 to-gray-800/50 rounded-2xl p-5 border border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-400 text-sm mb-1">Plan Type</p>
                            <p class="text-xl font-bold"><?= htmlspecialchars($member['plan_name'] ?? 'Not Assigned') ?>
                            </p>
                        </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-orange-400">₹<?= number_format($member['price'] ?? 0) ?>
                            </p>
                        </div>
                ...
                <div class="bg-gray-800/50 rounded-2xl p-6 border border-gray-700 hover:border-gray-600 transition-all">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center py-3 border-b border-gray-700/50">
                            ...
                            <span
                                class="text-lg font-semibold"><?= $member['height'] ? $member['height'] . ' cm' : '—' ?></span>
                        </div>
                        <div class="flex justify-between items-center py-3 border-b border-gray-700/50">
                            <span class="text-gray-400">Weight</span>
                            <span
                                class="text-lg font-semibold"><?= $member['weight'] ? $member['weight'] . ' kg' : '—' ?></span>
                        </div>
                        <div class="flex justify-between items-center py-3 border-b border-gray-700/50">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-right">
                                    ...
                                    <div class="w-24 h-2 bg-gray-700 rounded-full mt-2 overflow-hidden">
                                        <div class="h-full <?= str_replace('text', 'bg', $bmi_color) ?> rounded-full"
                                            style="width: <?= min(($bmi / 40) * 100, 100) ?>%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php if (!empty($member['medical_conditions'])): ?>
                        <div class="mt-6">
                            ...
                            <div
                                class="bg-gray-900/50 p-4 rounded-xl text-sm text-gray-300 leading-relaxed border border-gray-700">
                        ...
                        <div class="flex items-start gap-3 py-3 border-b border-gray-700/50">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="font-semibold">
                                    <?= htmlspecialchars($member['emergency_contact'] ?? 'Not Provided') ?>
                                </p>
                                <p class="text-sm text-gray-400 mt-1">
                                    <?= htmlspecialchars($member['emergency_phone'] ?? 'No phone provided') ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3 py-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-300 leading-relaxed">
                                    <?= nl2br(htmlspecialchars($member['address'] ?? 'No address provided')) ?>
                                </p>
                            </div>
                        </div>
                    </div>
