...
<div class="lg:ml-64 min-h-screen pt-16 lg:pt-0">
    <div class="p-4 lg:p-8">
        ...
        <div id="successToast" class="fixed top-6 right-6 bg-green-600 text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-3 z-50 max-w-xs lg:max-w-sm">
        ...
        <div class="bg-gray-900 p-4 lg:p-6 rounded-3xl mb-8">
            <form method="GET" class="flex flex-col lg:flex-row gap-4">
                ...
                <button type="submit" class="bg-orange-500 hover:bg-orange-600 px-8 py-4 rounded-2xl font-medium whitespace-nowrap">Filter</button>
            </form>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr class="border-t border-gray-800 hover:bg-gray-800/70">
                            ...
                            <td class="p-4 lg:p-6 text-center space-x-4">
                                ...
                                <a href="edit.php?id=<?= $member['id'] ?>" class="text-orange-400 hover:text-orange-500">
