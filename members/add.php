...
<div class="lg:ml-64 min-h-screen pt-16 lg:pt-0">
    <div class="p-4 lg:p-8 max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <a href="index.php"
                class="inline-flex items-center gap-2 text-gray-400 hover:text-orange-500 transition-colors duration-200 group">
        ...
        <div class="mb-10">
            ...
            <p class="text-gray-400 text-sm lg:text-base">Fill in the member's details below to register them into the
                system</p>
        </div>
        ...
        <form method="POST" enctype="multipart/form-data" class="space-y-6 lg:space-y-8">
            ...
            <div class="form-section pt-4">
                <button type="submit"
                    ...
                    <svg class="w-5 h-5 lg:w-6 lg:h-6 group-hover:rotate-12 transition-transform" fill="none"
                    ...
                    <svg class="w-5 h-5 lg:w-6 lg:h-6 opacity-0 group-hover:opacity-100 transition-all -translate-x-2 group-hover:translate-x-0"
